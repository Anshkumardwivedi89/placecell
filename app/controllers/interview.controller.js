...
exports.changeStatus = async (req, res) => {
    ...
    try {
       ...
       const user = await User.findOne({
         college_id: (interview.author_id).toUpperCase()
        }).select('college_id college_email student_name ');
            console.log(interview.author_id)
        if(interview.status === 'pending') {
            ...
            const notifyAuthor = await Mailer.sendDM(user, 'approveInterviewExperience');
