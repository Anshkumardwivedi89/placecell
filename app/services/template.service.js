...
const email_signature = '<br><br>With Regards.<br><br>Prof. Vishal Chhabra<br>In-charge, Training & Placement<br>IPS Academy Indore <br>+911212121212';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                subject: 'Login Request : Placement Cell, IPS Academy Indore ',
                text: 'Hello '+ data.student_name + 'We have received a login request for your account.Please find the below OTP to proceed further With Regards, Prof. Vishal Chhabra',
        ...
        case 'forgotPassword':
            return {
                from: from,
                to: data.college_email,
                subject: 'Reset Password Request : Placement Cell, IPS Academy Indore ',
                text: 'Hello '+ data.student_name + 'You requested for the reset password.Please find the below link Reset password With Regards, Prof. Vishal Chhabra',
        ...
        case 'passwordUpdated':
            return {
                from: from,
                to: data.college_email,
                subject: 'Password Updated : Placement Cell, IPS Academy Indore ',
                text: 'Hello '+ data.student_name + 'Your password has been successfully updated.With Regards, Prof. Vishal Chhabra',
        ...
        case 'approveInterviewExperience':
            return {
                from: from,
                to:data.college_email,
                subject: 'Yay! We have published your article ',
                text: 'Hello '+ data.student_name + 'Thanks for sharing your interview process and thoughts with us With Regards, Prof. Vishal Chhabra',
                html: 'Hello <strong>'+ data.student_name + '</strong>,<br><br>Thanks for sharing your interview process and thoughts with us to help others. We have published your interview experience after a few modifications. We wish you luck for the future!  ' + email_signature
            };
            break;
